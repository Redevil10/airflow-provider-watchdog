...
| Category    | Badges                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|-------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **License** | [![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![Airflow ecosystem](https://img.shields.io/badge/Airflow-ecosystem-017CEE.svg?logo=apacheairflow)](https://airflow.apache.org/ecosystem/)                                                                                                                                                                                                                                                                                |
...
- [x] Listed on the [Airflow ecosystem page](https://airflow.apache.org/ecosystem/) (Third-Party Plugins)
